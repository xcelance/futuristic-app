...
@section('content')
	...
	<section class="modules_list student">
        <div class="container">
                            ...
                            <tbody>
                                @foreach($studentList as $student)   
                                    <tr class="user_{{$student->id}}">
                                        <td><a href="{{url('students/?sid=')}}{{$student->id}}">{{$student->firstname}} {{$student->lastname}}</a></td>
                                        <td>{{$student->email}}</td>
                                        <td>{{$student->video_reviews}}</td>
                                        <td><a href="{{url('students/?sid=')}}{{$student->id}}"><span class="view"><i class="fa fa-eye" aria-hidden="true"></i></span></a></td>
                                    </tr>
                                @endforeach                             
                            </tbody>
                        </table>
