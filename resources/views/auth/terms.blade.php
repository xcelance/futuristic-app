...
•	Futuristic (The Site) is owned and operated by Futuristic Skills and Capabilities (we, us).
•	The Site refers to any and all access to Futuristic resources, via static or mobile devices, in either website or application format. Your access to and use of the Site (collectively, your Access) is conditional on your acceptance and compliance with the terms, conditions, notices and disclaimers contained or referred to on this page (Terms and Conditions). Your Access to the Site constitutes your agreement to be bound by the Terms and Conditions and that agreement may be enforced by us. If you do not agree with any of these Terms and Conditions, you must cease using the Site.
•	These Terms and Conditions apply to all users, regardless of whether a licence to Access the Site has been purchased by a school / educational institution on behalf of students and teachers, or directly by a student or parent. In the case of students who are minors, permission must be sought by that student’s school or parent / guardian (as applicable) before that student is provided with Access to the Site.
•	We reserve the right, at our discretion, to revise, amend and update the Terms and Conditions at any time effective on the date of posting to the Site of the new and amended provisions.
Privacy
...
•	You must not modify, copy, reproduce, republish, frame, reverse engineer, download onto a computer, upload to a third party, post, transmit or distribute this Content in any way except as expressly provided for in these Terms and Conditionsor with our express prior written consent.
User code of conduct and Access rights
•	Any user, including, students or teachers, found to be in breach of these Terms and Conditions, acting in a manner that we deem to be inappropriate or inconsistent with the spirit of these Terms and Conditions(e.g. submitting fraudulent results), or that is unlawful or prohibited by any laws applicable to the Site, may have their Access to the Site revoked.
•	You must not access or use the Site or the Content in any manner or for any purpose which is illegal or prohibited by any laws that apply to you, violates our rights in any way, or is prohibited by the Terms and Conditions.
•	Users of the Site must protect their usernames and passwords from unauthorised use. If you suspect any unauthorised use of your account, please notify us immediately.
...
•	Returns/Refunds Policy: Futuristic offers a no-questions-asked10 day money back guaranteefor individual subscription licences. No refunds will be offered after this time. 
...
•	in a manner which may be confusing, misleading ordeceptive;
•	in a manner that disparages us or our information, products or services (including this Site).
Termination
We may terminate access to this Site at any time without notice. The Terms and Conditionswill nevertheless survive any such termination.
...
General
•	We do not accept any liability for any failure to comply with the Terms and Conditionswhere the failure is due to circumstances beyond our reasonable control.
...
•	However, if we expressly waive any rights available to us under these Terms and Conditionson one occasion, this does not mean that those rights will automatically be waived on any other occasion.
•	If any of the Terms and Conditionsare held to be invalid, unenforceable or illegal for any reason, the remaining terms and conditions will nevertheless continue in full force.
...
•	Participants who do not comply with these Terms and Conditions, may be removed from the List of High Achieving Students or disqualified from the competition at any time, and we will use our complete discretion as to whether or not removal or disqualification occurs.
...
•	Any students, classes or schools intentionally misusing the Site be disqualified or removed from the List of High Achieving Students of the competition or challenge at any time. Examples of misuse include but are not limited to computer hacking of the Site, posting fraudulent results, using computer scripts to improve responses, scores or otherwise.
