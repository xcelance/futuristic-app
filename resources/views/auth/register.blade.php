    ...
    <div class="container">
        <div class="row">
            ...
            <div class="singup_left_outer">
                <h3>Sign Up</h3>
                <p>By signing up, you will become a member of the Futuristic community. For just $85(USD), you will get one year of unlimited access to all the content on the platform which will help you to prepare for the jobs of the future!</p>
                @if (count($errors) > 0)
                ...
                <form class="form-horizontal" role="form" method="POST">
                    {{ csrf_field() }}
                    <div class="first_outer01" id="usertype">                        
    ...
    @section('myjs')        
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                 $("#yearinschoolid").html('<select class="custom_select" name="yearinschool" >                 <option value="">Year in School</option><option value="7">Year 7</option><option value="8">Year 8</option><option value="9">Year 9</option><option value="10">Year 10</option><option value="11">Year 11</option><option value="12">Year 12</option></select>'); 

                $("div#usertype input").click(function(){
                    if($(this).val() == 'student'){
                        $("#yearinschoolid").html('<select class="custom_select" name="yearinschool" id="studentinyr" >                 <option value="">Year in School</option><option value="7">Year 7</option><option value="8">Year 8</option><option value="9">Year 9</option><option value="10">Year 10</option><option value="11">Year 11</option><option value="12">Year 12</option></select>');                        
                    }else{                        
                        $("#yearinschoolid").html('<input type="number" class="yearsinschool2" name="yearinschool" placeholder="How many years have you been teaching for?">');
                    }
                });
            });
        </script>
